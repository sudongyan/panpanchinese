...
class PHPMailer {
  ...
  /**
   * Holds the most recent phpmailer error message.
   * @var string
   */
  public $ErrorInfo         = '';
 ...
 /**
  ...
  /**
   * Adds a "Cc" address.
   * Note: this function works with the SMTP phpmailer on win32, not with the "mail" phpmailer.
   * @param string $address
   * @param string $name
   * @return boolean true on success, false if address already used
   */
 ...
 */
  ...
  protected function PostSend() {
    try {
      // Choose the phpmailer and send through it
      switch($this->Mailer) {
        case 'sendmail':
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      ...
      'mailer_not_supported' => ' phpmailer is not supported.',
